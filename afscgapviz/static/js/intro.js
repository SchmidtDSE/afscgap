...
const STEP_TEXTS = [
    ...
    "What about the Aleutian Islands? Did the same temperatures appear there? Try putting Gulf of Alaska data in one display and Aleutian Islands data in the other. Specifically, select 2015 in the Gulf of Alaska and 2014 in the Aleutian Islands (Pacific cod in both). Note that a survey does not happen in every region every year.",
    ...
    "Was this also true right before The Blob? Compare the Gulf of Alaska in 2013 to the Aleutian Islands in 2012.",
